...
public class QuiActivity extends AppCompatActivity {
    ...
    private AppCompatButton nexBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nexBtn = findViewById(R.id.nexBtn);
        ...
        nexBtn.setOnClickListener(v -> {
            ...
            if (selectedOptionByUser.isEmpty()){
                Toast.makeText(QuiActivity.this, "Please select an option", Toast.LENGTH_SHORT).show();
            }
            else {
        ...
        backBtn.setOnClickListener(v -> {
            ...
            startActivity(new Intent(QuiActivity.this, latActivity.class));
            finish();
        });
    }
    ...
    private void changeNextQuestion(){
        ...
        if (currentQuestionPosition < questionsLists.size()){
            ...
            Intent intent = new Intent(QuiActivity.this, QuizResults.class);
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (seconds == 0){
                    ...
                    Toast.makeText(QuiActivity.this, "Time Over", Toast.LENGTH_SHORT).show();
